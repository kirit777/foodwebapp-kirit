		...
		<div class="col-lg-9 col-md-9 col-sm-10 col-12">
			<div class="text">
				<div class="center">
					...
					<div>
						<form action="lib/add_order.php" method="post"><input hidden="true" type="text" name="item_id" value="<?php echo($item_id); ?>"><button type="submit" name="add_order" class="btn btn-danger">Order Now</button></form>

						<form action="lib/add_order.php" method="post"><input hidden="true" type="text" name="item_id" value="<?php echo($item_id); ?>"><button type="submit" name="add_cart" class="btn btn-success">Add To Cart</button></form>
					</div>
				</div>
			</div>
