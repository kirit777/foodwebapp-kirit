...
?>
	...
	<tr>
		...
		<td><label><?php echo($user_login); ?></label></td>
		...
		<td>
			<form action="lib/cancel_order.php" method="post">
				<input hidden="true" type="text" name="order_id" value="<?php echo($order_id); ?>">
				...
				<button type="submit" name="status" class="btn btn-info">Update</button></form>
		</td>
		<td>
